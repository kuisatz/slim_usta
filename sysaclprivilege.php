                ...
                if ($std['value'] != null) {
                    switch (trim($std['field'])) {
                        ...
                        case 'description':
                            ...
                            break;
                        case 'resource_name':
                            $stripper->offsetSet('resource_name', $stripChainerFactory->get(stripChainers::FILTER_PARANOID_LEVEL2, $app,$std['value']));
                            break; 
                        default:
                            break;
                    }
                ...
                if ($std['value'] != NULL) {                    
                    switch (trim($std['field'])) {
                        ...
                        case 'name_eng':
                                ...
                                $addfilterRules = '{"field":"name_eng","op":"contains","value":"'.$rnameEng.'"}';
                                $filterRules .= $addfilterRules;
                               // print_r($filterRules);
                            break;
                        case 'description':
                            ...
                            break;
                        case 'resource_name':
                                $rresourceName = $stripper->offsetGet('resource_name')->getFilterValue();
                            if ($addfilterRules != NULL) {$filterRules .=",";}
                                $addfilterRules = '{"field":"resource_name","op":"contains","value":"'.$rresourceName.'"}';
                                $filterRules .= $addfilterRules;
                              //  print_r($filterRules);
                            break;                        
                        default:
