 ...
 * @since 26-04-2016
 */
$app->get("/pkUpdate_infoUsersVerbal/", function () use ($app ) {
   $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('infoUsersVerbalBLL');    
    $headerParams = $app->request()->headers();  
    if (!isset($headerParams['X-Public'])) {
        throw new Exception('rest api "pkUpdate_infoUsersVerbal" end point, X-Public variable not found');
    }
    $pk = $headerParams['X-Public'];
 ...
 * @since 09-05-2016
 */
$app->get("/pkDeletedAct_infoUsersVerbal/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('infoUsersVerbalBLL');
    $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "pkcpkDeletedAct_infoUsersVerbal" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
 ...
 * @since 26-04-2016
 */
$app->get("/pkFillUsersVerbalNpk_infoUsersVerbal/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('infoUsersVerbalBLL');
    $headerParams = $app->request()->headers(); 
     if (!isset($headerParams['X-Public'])) {
        throw new Exception('rest api "pkFillUsersVerbalNpk_infoUsersVerbal" end point, X-Public variable not found');
    }
    $pk = $headerParams['X-Public'];
    $vLanguageCode = 'tr';
    if (isset($_GET['language_code'])) {
    ...
    $resDataGrid = $BLL->fillUsersVerbalNpk(array(
        'language_code' => $vLanguageCode,
    ...
    foreach ($resDataGrid as $flow) {
        $flows[] = array(
           ...
           // "firm_id" => $flow["firm_id"],
            ...
            "unpk" => html_entity_decode($flow["unpk"]),
 ...
 * @since 26-04-2016
 */
$app->get("/fillUsersVerbalNpkGuest_infoUsersVerbal/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('infoUsersVerbalBLL');
    $headerParams = $app->request()->headers();     
    ...
    $resDataGrid = $BLL->fillUsersVerbalNpkGuest(array(
        'language_code' => $vLanguageCode,
        'network_key' => $vNetworkKey,        
    ));
 ...
 * @since 23-05-2016
 */
$app->get("/pkGetUserVerbalConsultant_infoUsersVerbal/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();   
    $BLL = $app->getBLLManager()->get('infoUsersVerbalBLL');
    $headerParams = $app->request()->headers();     
    if (!isset($headerParams['X-Public'])) {
        throw new Exception('rest api "pkGetUserVerbalConsultant_infoUsersVerbal" end point, X-Public variable not found');
    }
    $pk = $headerParams['X-Public'];
    ...
    $result = $BLL->GetUserVerbalConsultant(array(
        'language_code' => $vLanguageCode,          
        'pk' => $pk,
        ));    
