 ...
 * @since 28.06.2016
 */
class SysMembershipTypes extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_membership_types tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_membership_types tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  28.06.2016  
     * @param array $params
     * @return array
     * @throws \PDOException
    ...
    public function getAll($params = array()) {
        try {
            ...
            $statement = $pdo->prepare("              
                SELECT 
                        a.id,
                        COALESCE(NULLIF(ax.mem_type, ''), a.mem_type_eng) AS mem_type,
                        a.mem_type_eng,	
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_membership_types ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_membership_types tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  28.06.2016
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    public function insert($params = array()) {
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                $kontrol = $this->haveRecords(array('language_id' => $languageIdValue,'mem_type' => $params['mem_type']));
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    
                    $sql = "
                INSERT INTO sys_membership_types(                        
                        mem_type, 
                        mem_type_eng, 
                        description, 
                        description_eng,
                ...
                VALUES (
                    ...
                    $statement->bindValue(':mem_type', $params['mem_type'], \PDO::PARAM_STR);
                    $statement->bindValue(':mem_type_eng', $params['mem_type_eng'], \PDO::PARAM_STR);
    ...
    /**
     * @author Okan CIRAN
     * @ sys_membership_types tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    public function haveRecords($params = array()) {
        try {
            ...
            FROM sys_membership_types  a                          
            WHERE 
                LOWER(TRIM(a.mem_type)) = LOWER(TRIM('" . $params['mem_type'] . "')) AND
    ...
    /**
     * @author Okan CIRAN
     * sys_membership_types tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  28.06.2016
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    public function update($params = array()) {
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                $kontrol = $this->haveRecords(array('id' => $params['id'],'language_id' => $languageIdValue,'mem_type' => $params['mem_type']));
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    $sql = "
                    UPDATE sys_membership_types
                    SET 
                        mem_type= :mem_type, 
                        mem_type_eng= :mem_type_eng, 
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_membership_types tablosundan kayıtları döndürür !!
     * @version v 1.0  28.06.2016
    ...
    public function fillGrid($args = array()) {
        ...
        if (isset($args['sort']) && $args['sort'] != "") {
            ...
            $sort = "a.language_id ,a.priority , mem_type ";
        }
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_membership_types tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  28.06.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /** 
     * @author Okan CIRAN
     * @ sosyal medya bilgilerini dropdown ya da tree ye doldurmak için sys_membership_types tablosundan kayıtları döndürür !!
     * @version v 1.0  28.06.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException 
     ...
     * @author Okan CIRAN
     * @ sys_membership_types tablosundan parametre olarak  gelen id kaydın aktifliğini
