 ...
 * @since 05.05.2016
 */
class SysSocialMedia extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_socialmedia tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_socialmedia tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  05.05.2016  
     * @param array $params
     * @return array
     * @throws \PDOException
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_socialmedia su ON (su.id = a.id OR su.language_parent_id = a.id) AND su.deleted =0 AND su.active =0 AND lx.id = su.language_id
                
                ORDER BY a.language_id ,a.priority , name
                                 ");
    ...
    /**
     * @author Okan CIRAN
     * @ sys_socialmedia tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  05.05.2016
     * @param type $params
     * @return array
     * @throws \PDOException
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                VALUES (
                    ...
                    $insertID = $pdo->lastInsertId('sys_socialmedia_id_seq');
                    $errorInfo = $statement->errorInfo();
                    if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                        throw new \PDOException($errorInfo[0]);
                    $pdo->commit();
    ...
    /**
     * @author Okan CIRAN
     * @ sys_socialmedia tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    public function haveRecords($params = array()) {
      ...
      /**
     * @author Okan CIRAN
     * sys_socialmedia tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  05.05.2016
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_socialmedia tablosundan kayıtları döndürür !!
     * @version v 1.0  05.05.2016
    ...
    public function fillGrid($args = array()) {
        ...
        if (isset($args['sort']) && $args['sort'] != "") {
            ...
            $sort = "a.language_id ,a.priority , name ";
        }
     ...
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_socialmedia tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  05.05.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /** 
     * @author Okan CIRAN
     * @ sosyal medya bilgilerini dropdown ya da tree ye doldurmak için sys_socialmedia tablosundan kayıtları döndürür !!
     * @version v 1.0  05.05.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    public function fillSocicalMediaDdList($params = array()) {
        try {
            ...
            $statement = $pdo->prepare("        
                ...
                INNER JOIN sys_language l ON l.id = a.language_id AND l.deleted =0 AND l.active =0  
		LEFT JOIN sys_language lx ON lx.id =" . intval($languageIdValue). " AND lx.deleted =0 AND lx.active =0                      		
                LEFT JOIN sys_socialmedia sd ON (sd.id =a.id OR sd.language_parent_id = a.id) AND sd.deleted =0 AND sd.active =0 AND lx.id = sd.language_id   
                WHERE                    
                    a.deleted = 0 AND
     ...
     * @author Okan CIRAN
     * @ sys_socialmedia tablosundan parametre olarak  gelen id kaydın aktifliğini
