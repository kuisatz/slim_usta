...
class InfoUsersVerbal extends \DAL\DalSlim {
    ...
    /**   
     * @author Okan CIRAN
     * @ info_users_verbal tablosuna aktif olan diller için ,tek bir kaydın tabloda olmayan diğer dillerdeki kayıtlarını oluşturur   !!
     * @version v 1.0  23.06.2016
     * @return array
     * @throws \PDOException
     */
    ...
    /**
     * @author Okan CIRAN
     * @ text alanları doldurmak için info_users_verbal tablosundan tek kayıt döndürür !! 
