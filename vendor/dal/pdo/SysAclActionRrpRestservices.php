 ...
 * @author Okan CIRAN
 */
class SysAclActionRrpRestservices extends \DAL\DalSlim {

    /**     
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**    
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  16-08-2016  
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**    
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices tablosunda role_id, resource_id ve privilege_id aynı kayıtta daha önce oluşturulmuş mu? 
     * @version v 1.0 16-08-2016
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    public function haveRecords($params = array()) {
        try {
            ...
            FROM sys_acl_action_rrp_restservices
     ...
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  16-08-2016
     * @param type $params
     * @return array
     * @throws \PDOException
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    $sql = "
                INSERT INTO sys_acl_action_rrp_restservices(
                       rrp_id, 
                       restservices_id, 
                       description,
                       op_user_id)
    ...
    /**
      * @author Okan CIRAN
     * @ Gridi doldurmak için sys_acl_action_rrp_restservices tablosundan kayıtları döndürür !!
     * @version v 1.0  16-08-2016
    ...
    /**     
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_acl_action_rrp_restservices tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  16-08-2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices bilgilerini döndürür !!
     * filterRules aktif 
     * @version v 1.0  16-08-2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
     * fillActionRrpRestServicesList
     */
    ...
    /**
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices bilgilerinin sayısını döndürür !!
     * filterRules aktif 
     * @version v 1.0  16-08-2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
     * fillActionRrpRestServicesListRtc
     */                     
    ...
    /**
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices tablosundan rrp_id si verilen kayıtları döndürür !! 
    ...
    public function fillActionRestServicesOfPrivileges($params = array()) {
        try {
            ...
            $sql ="             
                ...
                INNER JOIN sys_acl_action_rrp rrp ON rrp.id = a.rrp_id AND rrp.deleted =0 AND rrp.active =0
                INNER JOIN sys_acl_roles rr ON rr.id = rrp.role_id AND rr.deleted = 0 AND rr.active = 0 
                INNER JOIN sys_acl_action_resources rs ON rs.id = rrp.resource_id AND rs.deleted = 0 AND rs.active = 0 
                INNER JOIN sys_action_privileges rp ON rp.id = rrp.privilege_id AND rp.deleted = 0 AND rp.active = 0
                " . $whereSql . "
                ORDER BY aclr.name
                                 ";
            $statement = $pdo->prepare($sql); 
    ...
    /**
     * @author Okan CIRAN
     * @ sys_acl_action_rrp_restservices tablosundan rrp_id si dısında kalan kayıtları döndürür !! 
     * @version v 1.0  28.07.2016 
     * @param array | null $args
     * @return array
     * @throws \PDOException
     * fillNotInActionRestServicesOfPrivileges
     */                      
     ...
     * @return array
     * @throws \PDOException
     * fillNotInActionRestServicesOfPrivilegesRtc
     */                      
    ...
    /** 
     * @author Okan CIRAN
     * @ tree doldurmak için sys_acl_action_rrp_restservices tablosundan rrp_id si dısında kalan kayıtları döndürür !! 
     * @version v 1.0  16.08.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
     * fillNotInActionServicesGroupsTree
     */
    public function fillNotInActionServicesGroupsTree($params = array()) {
        try {
            $pdo = $this->slimApp->getServiceManager()->get('pgConnectFactory');
    ...
    /**  
     * @author Okan CIRAN
     * @ tree doldurmak için sys_acl_action_rrp_restservices tablosundan rrp_id si dısında kalan kayıtların sayısını döndürür !! 
     * @version v 1.0  16.08.2016 
     * @param array | null $args
     * @return array
     * @throws \PDOException
     * fillNotInActionRestServicesTree
     */
    public function fillNotInActionRestServicesTree($params = array()) {
        try {
            $pdo = $this->slimApp->getServiceManager()->get('pgConnectFactory');                            
    ...
    /** 
     * @author Okan CIRAN
     * @ tree doldurmak için sys_acl_action_rrp_restservices tablosundan yetki ile ilişkili olan kayıtların servis gruplarını döndürür !! 
     * @version v 1.0 02.08.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
     */                        
     public function fillActionRestServicesGroupsOfPrivilegesTree($params = array()) {
        try {
            $pdo = $this->slimApp->getServiceManager()->get('pgConnectFactory');
            ...
            $sql = " SELECT * FROM (
               SELECT
					...
					xz.id in (
							...
							FROM sys_acl_action_rrp_restservices ax
        ...
        try {
            ...
            $sql ="  
			   ...
			   (SELECT DISTINCT aq.id
				FROM sys_acl_action_rrp_restservices aq
    ...
    public function haveActionRecords($params = array()) {
        try {
            ...
            INNER JOIN sys_acl_action_rrp_restservices sarrr ON sarrr.id= a.rrp_restservice_id 
