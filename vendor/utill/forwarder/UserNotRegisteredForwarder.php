 ...
 * @author Okan CIRAN
 */
class UserNotRegisteredForwarder extends \Utill\Forwarder\AbstractForwarder {
    ...
    public  function redirect() {
        ...
        $ch = curl_init('http://localhost/ustalar/Slim_Redirect_usta/index.php/userNotRegisteredSlim');
